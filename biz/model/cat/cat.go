...
var UploadResp_Base_DEFAULT *BaseResponse

func (p *UploadResp) GetBase() (v *BaseResponse) {
	if !p.IsSetBase() {
		return UploadResp_Base_DEFAULT
	}
	return p.Base
}

func (p *UploadResp) GetData() (v map[string]string) {
	return p.Data
}
...
func (p *UploadResp) IsSetBase() bool {
	return p.Base != nil
}
...
type CatService interface {
	UploadFile(ctx context.Context, req *BaseRequest) (r *UploadResp, err error)
...
func (p *CatServiceClient) UploadFile(ctx context.Context, req *BaseRequest) (r *UploadResp, err error) {
	var _args CatServiceUploadFileArgs
	_args.Req = req
	var _result CatServiceUploadFileResult
...
func NewCatServiceProcessor(handler CatService) *CatServiceProcessor {
	...
	self.AddToProcessorMap("UploadFile", &catServiceProcessorUploadFile{handler: handler})
...
type catServiceProcessorUploadFile struct {
	handler CatService
}

func (p *catServiceProcessorUploadFile) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CatServiceUploadFileArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CatServiceUploadFileResult{}
...
type CatServiceUploadFileArgs struct {
	Req *BaseRequest `thrift:"req,1"`
}

func NewCatServiceUploadFileArgs() *CatServiceUploadFileArgs {
	return &CatServiceUploadFileArgs{}
}

var CatServiceUploadFileArgs_Req_DEFAULT *BaseRequest

func (p *CatServiceUploadFileArgs) GetReq() (v *BaseRequest) {
	if !p.IsSetReq() {
		return CatServiceUploadFileArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_CatServiceUploadFileArgs = map[int16]string{
	1: "req",
}

func (p *CatServiceUploadFileArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CatServiceUploadFileArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CatServiceUploadFileArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CatServiceUploadFileArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CatServiceUploadFileArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *CatServiceUploadFileArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *CatServiceUploadFileArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CatServiceUploadFileArgs(%+v)", *p)
}

type CatServiceUploadFileResult struct {
	Success *UploadResp `thrift:"success,0,optional"`
}

func NewCatServiceUploadFileResult() *CatServiceUploadFileResult {
	return &CatServiceUploadFileResult{}
}

var CatServiceUploadFileResult_Success_DEFAULT *UploadResp

func (p *CatServiceUploadFileResult) GetSuccess() (v *UploadResp) {
	if !p.IsSetSuccess() {
		return CatServiceUploadFileResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_CatServiceUploadFileResult = map[int16]string{
	0: "success",
}

func (p *CatServiceUploadFileResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CatServiceUploadFileResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CatServiceUploadFileResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CatServiceUploadFileResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *CatServiceUploadFileResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *CatServiceUploadFileResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *CatServiceUploadFileResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CatServiceUploadFileResult(%+v)", *p)
}
